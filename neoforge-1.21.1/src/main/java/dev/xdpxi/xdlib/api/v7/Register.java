...
public final class Register {
  ...
  /**
   * Initializes and tests the registration of a block, an item, and an armor material. Logs the
   * results of each registration attempt.
   */
  public static void init() {
    ...
    try {
      test_item = registerItem(Item::new, new Item.Properties(), "test_item", Constants.MOD_ID);
  ...
  public static ArmorMaterial registerMaterial(
      ...
      boolean dyeable,
      String MOD_ID) {
    ResourceLocation id = ResourceLocation.fromNamespaceAndPath(MOD_ID, material_id);

    List<ArmorMaterial.Layer> layers = List.of(new ArmorMaterial.Layer(id, "", dyeable));
    ...
    return Registry.register(BuiltInRegistries.ARMOR_MATERIAL, id, material);
  }
}
